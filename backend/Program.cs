...
using backend.Modules.DailyOperatingLoop.Extensions;
using backend.Modules.AutomationStudio.Extensions;
using backend.Modules.Automation.Extensions;
...
using backend.Modules.CommandCenter.Extensions;
using backend.Seed;
...
using backend.Modules.BusinessMemory.Extensions;
using backend.Modules.Outcomes.Extensions;
...
builder.Services.AddBusinessMemoryModule();
builder.Services.AddActionCenterModule();
builder.Services.AddAutomationEngine();
builder.Services.AddCommandCenterModule();
builder.Services.AddOutcomesModule();
builder.Services.AddDailyOperatingLoopModule();
