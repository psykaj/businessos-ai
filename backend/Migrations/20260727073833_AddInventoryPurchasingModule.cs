...
{
    /// <inheritdoc />
    public partial class AddInventoryPurchasingModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnTimeDeliveriesCount = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicShareToken = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignatureCertificateUrl = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationBin = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsParallelGroup = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignerUserId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_OrganizationId",
                table: "ApprovalRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalSteps_OrganizationId",
                table: "ApprovalSteps",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentAuditEntries_Action",
                table: "DocumentAuditEntries",
                column: "Action");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentAuditEntries_DocumentId",
                table: "DocumentAuditEntries",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentAuditEntries_OrganizationId",
                table: "DocumentAuditEntries",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentAuditEntries_PerformedById",
                table: "DocumentAuditEntries",
                column: "PerformedById");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentAuditEntries_Timestamp",
                table: "DocumentAuditEntries",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentVersions_OrganizationId",
                table: "DocumentVersions",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceipts_OrganizationId",
                table: "GoodsReceipts",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryStocks_OrganizationId_ProductId_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedDocuments_OrganizationId",
                table: "SharedDocuments",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedDocuments_PublicShareToken",
                table: "SharedDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignatureRecipients_OrganizationId",
                table: "SignatureRecipients",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRecipients_SecurityToken",
                table: "SignatureRecipients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignatureRecipients_SignerEmail",
                table: "SignatureRecipients",
                column: "SignerEmail");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRecipients_Status",
                table: "SignatureRecipients",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequests_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequests_OrganizationId",
                table: "SignatureRequests",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequests_SecurityHash",
                table: "SignatureRequests",
                column: "SecurityHash");
